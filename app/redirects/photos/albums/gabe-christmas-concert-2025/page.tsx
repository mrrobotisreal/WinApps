...
const REDIRECT_URL = "https://photos.app.goo.gl/SGNHkBcT9WdCuTBx7";
const ALBUM_NAME = "Gabe Christmas Concert 2025";
const ALBUM_SLUG = "gabe-christmas-concert-2025";
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-10">
      <div className="text-center w-full max-w-md">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-green-900/40 via-black to-red-900/40 shadow-xl">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(74,222,128,0.35),transparent_38%),radial-gradient(circle_at_70%_70%,rgba(248,113,113,0.35),transparent_35%)]" />
            <div className="absolute inset-0 flex items-center justify-center">
              <Image
                src="https://pub-5e3f5f69f6bd4f2fb6bc741e03f34851.r2.dev/gabe_christmas_concert_2025.jpg"
        ...
        <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
          ...
          <span className="bg-gradient-to-b from-red-300 to-red-800 bg-clip-text text-transparent">
            {" "}
            Christmas{" "}
          </span>
          <span className="bg-gradient-to-b from-green-400 to-green-700 bg-clip-text text-transparent">
        ...
        {isPreparingRedirect ? (
          ...
          <div className="mt-4 text-xl">
            ...
            <span className="bg-gradient-to-b from-green-400 to-green-700 bg-clip-text text-transparent font-bold">
              {countdown}
            </span>
            <span className="bg-gradient-to-b from-red-300 to-red-800 bg-clip-text text-transparent">
        ...
        <button
          ...
          className="mt-8 inline-flex w-full justify-center rounded-lg bg-gradient-to-br from-green-400 to-green-700 border border-red-500 px-6 py-3 text-lg font-bold text-white shadow-lg shadow-green-900/30 transition hover:scale-[1.02] hover:shadow-green-800/40 focus:outline-none focus:ring-2 focus:ring-red-500/60 cursor-pointer"
        >
          View Now
        </button>
      </div>
