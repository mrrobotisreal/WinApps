        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    <strong className="text-orange-600 dark:text-orange-400">Voizy</strong> is a{" "}
                    <em className="text-purple-600 dark:text-purple-400">social media app</em> written entirely in{" "}
                    <strong className="text-orange-600 dark:text-orange-400">Kotlin</strong> and{" "}
                    <strong className="text-orange-600 dark:text-orange-400">Jetpack Compose</strong> for{" "}
                    <em className="text-purple-600 dark:text-purple-400">Android</em>. Create your account, update your profile info, add images, pick a profile pic and a cover pic, upload a song to be played when people visit your profile (courtesy of{" "}
                    <em className="text-purple-600 dark:text-purple-400">Epidemic Sound</em>), search for people and send friend requests, publish posts to the main feed or on a friend&apos;s page, react to posts, leave comments on posts and react to comments, re-post someone else&apos;s post with your own thoughts, create posts with images, location, hashtags, groups, and tags added, create a poll on your post to see everyone&apos;s answers and generate interactions, view recommended posts in different feeds, join and create groups that others can join where you can discuss certain topics, get notifications of new posts and customize which notifications you&apos;d like to receive, and so much more!
                  </p>
                  <p className="text-muted-foreground">
                    This project is incredibly fun to work on and I&apos;ve been{" "}
                    <em className="text-purple-600 dark:text-purple-400">learning</em>{" "}
                    <em className="text-purple-600 dark:text-purple-400 font-bold">SO</em>{" "}
                    <em className="text-purple-600 dark:text-purple-400">much</em>, particularly about dealing with{" "}
                    <strong className="text-orange-600 dark:text-orange-400">low-level Android device features</strong> for{" "}
                    <strong className="text-orange-600 dark:text-orange-400">secure storage</strong> of{" "}
                    <em className="text-purple-600 dark:text-purple-400">JWTs</em> and{" "}
                    <em className="text-purple-600 dark:text-purple-400">API keys</em>,{" "}
                    <strong className="text-orange-600 dark:text-orange-400">integrating 3rd party libraries</strong> and dependencies for things like{" "}
                    <strong className="text-orange-600 dark:text-orange-400">dependency injection</strong> and{" "}
                    <strong className="text-orange-600 dark:text-orange-400">Google Maps</strong>,{" "}
                    <strong className="text-orange-600 dark:text-orange-400">caching</strong> of things like{" "}
                    <em className="text-purple-600 dark:text-purple-400">posts</em>,{" "}
                    <em className="text-purple-600 dark:text-purple-400">images</em> and{" "}
                    <em className="text-purple-600 dark:text-purple-400">audio</em>,{" "}
                    <strong className="text-orange-600 dark:text-orange-400">complex SQL joins</strong> including developing my own{" "}
                    <strong className="text-orange-600 dark:text-orange-400">custom recommended posts feed algorithm</strong> strictly with{" "}
                    <em className="text-purple-600 dark:text-purple-400">Go code</em>,{" "}
                    <strong className="text-orange-600 dark:text-orange-400">complex SQL queries</strong> and{" "}
                    <em className="text-purple-600 dark:text-purple-400">indexed columns and tables</em>, and so much more!
                  </p>
                </div>
              </div>
              ...
              {/* Technical Details */}
              <div>
                <h2 className="text-2xl font-bold mb-4">Technical Contributions</h2>
                ...
                <Accordion type="multiple" className="w-full">
                  ...
                  <AccordionItem value="android-frontend">
                    ...
                    <AccordionContent>
                      <div className="space-y-4">
                        <p>
                          Built a comprehensive Android social media application using <Badge variant="secondary">Kotlin</Badge> and <Badge variant="secondary">Jetpack Compose</Badge>. The app features a modern, intuitive UI with advanced functionality including profile management, social feeds, friend systems, and multimedia content creation.
                        </p>
                        <div className="space-y-2">
                          <p><strong>Key Features:</strong></p>
                          <ul className="space-y-1 ml-4">
                            <li>• Complete user authentication and profile management</li>
                            <li>• Social feed with posts, reactions, and comments</li>
                            <li>• Friend system with search and friend requests</li>
                            <li>• Media upload (images, audio) with compression and optimization</li>
                            <li>• Location-based posting with Google Maps integration</li>
                            <li>• Real-time notifications and customizable settings</li>
                  ...
                  <AccordionItem value="backend-integration">
                    ...
                    <AccordionContent>
                      <div className="space-y-4">
                        <p>
                          Designed and implemented a robust backend system using <Badge variant="secondary">Go</Badge> with complex <Badge variant="secondary">MySQL</Badge> database operations and custom algorithms for content recommendation.
                        </p>
                        <div className="space-y-2">
                          <p><strong>Backend Achievements:</strong></p>
                          <ul className="space-y-1 ml-4">
                            ...
                            <li>• Efficient caching systems for posts, images, and audio</li>
                          </ul>
                        </div>
                      </div>
                    </AccordionContent>
                  ...
                  <AccordionItem value="security-performance">
                    ...
                    <AccordionContent>
                      <div className="space-y-4">
                        <p>
                          Implemented advanced security measures and performance optimizations for Android devices, focusing on secure storage and efficient resource management.
                        </p>
                        <div className="space-y-2">
                          <p><strong>Security & Performance Features:</strong></p>
                          <ul className="space-y-1 ml-4">
                            <li>• Low-level Android device features for secure storage</li>
                            <li>• Encrypted local storage for sensitive data</li>
                            <li>• Optimized image and media caching</li>
                            <li>• Dependency injection with <Badge variant="secondary">Dagger/Hilt</Badge></li>
                            <li>• Memory-efficient data loading and pagination</li>
                          </ul>
                        </div>
                      </div>
                    </AccordionContent>
                  ...
                  <AccordionItem value="integrations">
                    ...
                    <AccordionContent>
                      <div className="space-y-4">
                        <p>
                          Successfully integrated multiple third-party services to enhance app functionality and user experience.
                        </p>
                        <div className="space-y-2">
                          <p><strong>Integrated Services:</strong></p>
                          <ul className="space-y-1 ml-4">
                            <li>• <Badge variant="secondary">Google Maps API</Badge> for location services</li>
                            <li>• <Badge variant="secondary">Epidemic Sound</Badge> for profile music</li>
                            <li>• <Badge variant="secondary">Firebase</Badge> for push notifications</li>
                            <li>• Custom media processing for audio and image optimization</li>
