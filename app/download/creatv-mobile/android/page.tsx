...
export default function AndroidDownloadPage() {
  ...
  useEffect(() => {
    ...
    const downloadFile = () => {
      ...
      link.href =
        "https://pub-5e3f5f69f6bd4f2fb6bc741e03f34851.r2.dev/build-1770091566601.apk";
      link.download = "CreaTV-Android-development-build.apk";
    ...
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="mb-8 flex justify-center">
          <Image
            src="https://pub-5e3f5f69f6bd4f2fb6bc741e03f34851.r2.dev/CreaTV_Icon_256x256.png"
            alt="CreaTV Icon"
            width={256}
            height={256}
        ...
        {/* Title Text */}
        {isDownloading ? (
          <h1 className="text-4xl md:text-5xl font-medium mb-8 flex flex-wrap items-center justify-center gap-0.25">
