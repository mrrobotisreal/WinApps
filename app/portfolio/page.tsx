        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                <div className="flex justify-center w-full">
                  <Image src="https://winapps-solutions-llc.s3.us-west-2.amazonaws.com/images/portfolio/amazon-connect/AmazonConnectBanner.webp" alt="Amazon Connect" width={1500} height={300} className="rounded-md" />
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                <div className="flex justify-center w-full">
                  <Image src="https://winapps-solutions-llc.s3.us-west-2.amazonaws.com/images/portfolio/vmware/VMwareBanner.webp" alt="VMware" width={1500} height={300} className="rounded-md" />
                </div>
                <p className="text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                <div className="flex justify-center w-full">
                  <Image src="https://winapps-solutions-llc.s3.us-west-2.amazonaws.com/images/portfolio/double-raven/DoubleRavenBanner.webp" alt="Double Raven" width={1500} height={300} className="rounded-md" />
                </div>
                <p className="text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                <div className="flex justify-center w-full">
                  <Image src="https://winapps-solutions-llc.s3.us-west-2.amazonaws.com/images/ProjectsBanner.webp" alt="Personal Projects" width={1500} height={300} className="rounded-md" />
                </div>
                <p className="text-muted-foreground">
