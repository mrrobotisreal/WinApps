                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="frontend">
                            ...
                            <AccordionContent>
                              I built the frontend for the app that allows users to format text in bold, italic, underline, strikethrough, monospace, and then copy the formatted text to the clipboard and paste it into LinkedIn, X (Twitter), Facebook, and more and it will retain its formatting. This also includes nested bullet lists and numbered lists. This frontend is built with <Badge variant="secondary">Vite</Badge>, <Badge variant="secondary">TypeScript</Badge>, <Badge variant="secondary">React</Badge>, <Badge variant="secondary">shadcn/ui & Radix UI</Badge>, and <Badge variant="secondary">Tailwind CSS</Badge>.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
