...
const REDIRECT_URL = "https://photos.app.goo.gl/zWBkiY3iwobVVc4Q6";
const ALBUM_NAME = "Portugal";
const ALBUM_SLUG = "portugal";

export default function PortugalRedirectPage() {
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-red-600 via-black to-emerald-800 shadow-xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Image
                src="https://pub-5e3f5f69f6bd4f2fb6bc741e03f34851.r2.dev/portugal-album-cover.jpg"
                alt="Portugal album preview"
                width={236}
                height={314}
