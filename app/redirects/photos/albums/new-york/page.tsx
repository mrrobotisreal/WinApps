  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-10">
      <div className="text-center w-full max-w-md">
        ...
        <div className="mb-8">
          <svg
            className="w-16 h-16 mx-auto text-emerald-300"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-emerald-700/30 via-black to-emerald-900/40 shadow-xl">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(110,231,183,0.35),transparent_38%),radial-gradient(circle_at_70%_70%,rgba(52,211,153,0.35),transparent_35%)]" />
            <div className="absolute inset-0 flex items-center justify-center">
              <Image
                src="https://pub-5e3f5f69f6bd4f2fb6bc741e03f34851.r2.dev/new-york.jpg"
        ...
        <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
          ...
          <span className="bg-gradient-to-b from-emerald-200 to-emerald-500 bg-clip-text text-transparent">
            New York
          </span>
          <span className="bg-gradient-to-b dark:from-white dark:to-gray-400 from-gray-400 to-black bg-clip-text text-transparent">
            {" "}
        ...
        {isPreparingRedirect ? (
          <div className="relative">
            <Loader className="w-16 h-16 mx-auto text-emerald-300 animate-spin" />
          ...
          <div className="mt-4 text-xl">
            ...
            <span className="bg-gradient-to-b from-emerald-200 to-emerald-500 bg-clip-text text-transparent font-bold">
              {countdown}
            </span>
            <span className="bg-gradient-to-b from-emerald-300 to-emerald-700 bg-clip-text text-transparent">
