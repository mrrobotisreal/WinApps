        ...
        <nav className="flex mb-8" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                <span className="mx-2">/</span>
                <span className="text-muted-foreground">Finance Flow</span>
              </div>
            </li>
          </ol>
        </nav>
            ...
            <CardContent className="p-6 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {new Date("2025-09-28T00:00:00Z").toLocaleDateString()} -
                    Present
                  </p>
                </div>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="backend">
                            ...
                            <AccordionContent>
                              I built the backend for the app. This backend is
                              built with{" "}
                              <Badge variant="secondary">Node.js</Badge> and{" "}
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="frontend">
                            ...
                            <AccordionContent>
                              I built the frontend for the app. This frontend is
                              built with <Badge variant="secondary">Vite</Badge>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    You can{" "}
                    <Link
                      href="https://www.financeflow.link/"
                      target="_blank"
