        ...
        <nav className="flex mb-8" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                <span className="mx-2">/</span>
                <span className="text-muted-foreground">Media Manipulator Pro</span>
              </div>
            </li>
          </ol>
        </nav>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="backend">
                            ...
                            <AccordionContent>
                              I built the backend for the app that allows users to upload images, videos, and audio files to manipulate them. This backend is built with <Badge variant="secondary">Go</Badge> and <Badge variant="secondary">Gin</Badge> for the REST API. The media &quot;manipulation&quot; is done with <Badge variant="secondary">FFmpeg</Badge> and <Badge variant="secondary">ImageMagick</Badge>.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="frontend">
                            ...
                            <AccordionContent>
                              I built the frontend for the app that allows users to upload images, videos, and audio files to manipulate them. This frontend is built with <Badge variant="secondary">Vite</Badge>, <Badge variant="secondary">TypeScript</Badge>, <Badge variant="secondary">React</Badge>, <Badge variant="secondary">shadcn/ui & Radix UI</Badge>, and <Badge variant="secondary">Tailwind CSS</Badge>.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="deployment">
                            ...
                            <AccordionContent>
                              I deployed the app on custom non-cloud servers for the backend API and Vercel for the frontend, pointed DNS to the servers, properly configured with TLS/SSL, rate limiting, and other security measures. I also integrated with Google AdSense and Google Analytics for monetization, analytics, and metrics.
                            </AccordionContent>
                          </AccordionItem>
