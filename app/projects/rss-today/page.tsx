                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="backend">
                            ...
                            <AccordionContent>
                              I built the backend for the app that continuously
                              monitors RSS feeds for new content and updates the
                              database with the new content. This backend is
                              built with <Badge variant="secondary">Go</Badge>{" "}
                              and <Badge variant="secondary">Gin</Badge> for the
                              REST API, and{" "}
                              <Badge variant="secondary">PostgreSQL</Badge> for
                              the database.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                        ...
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="frontend">
                            ...
                            <AccordionContent>
                              ...
                              to get real-time news and updates from their
                              favorite news sources via RSS feeds, including the
                              ability to search for news sources by name and
                              create alerts for specific news sources and
                              subjects. It does require an account to use, but
                              it is free to use, and the account registration
                              and login is implemented securely with{" "}
                              <Badge variant="secondary">Firebase</Badge>. This
                        ...
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="deployment">
                            ...
                            <AccordionContent>
                              ...
                              measures. I also integrated with{" "}
