            ...
            <CardContent className="p-6 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {new Date("2024-11-02T00:00:00Z").toLocaleDateString()} - {new Date("2025-02-01T00:00:00Z").toLocaleDateString()}
                  </p>
                </div>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="video">
                            ...
                            <AccordionContent>
                              I built a video conferencing feature for classes that allows users to join a class and interact with the instructor and other students in real-time, and it also allows the instructor to share their screen with the class. This feature is built with <Badge variant="secondary">WebRTC</Badge> and <Badge variant="secondary">WebSockets</Badge> to allow for real-time communication between the instructor and students.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="chatbot">
                            ...
                            <AccordionContent>
                              I built a chatbot for the app that allows users to ask questions about the app and get answers. This chatbot is built with <Badge variant="secondary">OpenAI</Badge> and <Badge variant="secondary">WebSockets</Badge> to allow for real-time streaming of responses.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="chat">
                            ...
                            <AccordionContent>
                              I built a chat feature for the app that allows users to chat with the chatbot and other users in the app. This feature is built with <Badge variant="secondary">MongoDB</Badge> and <Badge variant="secondary">WebSockets</Badge> to allow for real-time notifications of new messages.
                            </AccordionContent>
                          </AccordionItem>
                          ...
                          <AccordionItem value="chat-images">
                            ...
                            <AccordionContent>
                              I added image uploading to the chat feature that allows users to send images to other users in the chat. This feature is built with <Badge variant="secondary">S3</Badge> and <Badge variant="secondary">WebSockets</Badge> to allow for real-time notifications of new messages.
                            </AccordionContent>
                          </AccordionItem>
                          ...
                          <AccordionItem value="chat-audio">
                            ...
                            <AccordionContent>
                              I added voice recording messages to the chat feature that allows users to record voice messages and send them to other users in the chat. This feature is built with <Badge variant="secondary">WebSockets</Badge> to allow for real-time notifications of new messages, and users can also play the voice messages in the chat.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
                      ...
                      <AccordionContent>
                        <Accordion type="multiple" className="w-full">
                          <AccordionItem value="payments">
                            ...
                            <AccordionContent>
                              I built a secure checkout system for payments that allows users to purchase lessons and other products in the app. This system is built with <Badge variant="secondary">Stripe</Badge>.
                            </AccordionContent>
                          </AccordionItem>
                        </Accordion>
                      </AccordionContent>
